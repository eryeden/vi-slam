...
class GeneralProjectionFactor
 ...
 public:
  ...
  typedef GeneralProjectionFactor<POSE, LANDMARK> This;

  /// shorthand for a smart pointer to a factor
  typedef boost::shared_ptr<This> shared_ptr;

  /// Default constructor
  GeneralProjectionFactor()
  ...
  GeneralProjectionFactor(
      ...
      gtsam::Key poseKey,
      gtsam::Key pointKey,
      const std::shared_ptr<vslam::data::CameraModelBase>& K,
  ...
  /** Virtual destructor */
  virtual ~GeneralProjectionFactor() {}
  ...
  inline const std::shared_ptr<vslam::data::CameraModelBase> calibration()
      const {
    return K_;
  }
