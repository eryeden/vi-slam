...
static Mat cvcloud_load() {
  ...
  ifstream ifs("/home/ery/Works/Devel/vi-slam/docs/smaple/bun000.ply");
  string str;
...
int main(int argn, char **argv) {
  ...
  Affine3f transform =
      viz::makeTransformToGlobal(Vec3f(0.0f, -1.0f, 0.0f), Vec3f(-1.0f, 0.0f, 0.0f), Vec3f(0.0f, 0.0f, -1.0f), cam_pos);
